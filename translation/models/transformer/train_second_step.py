...
train_iter = GecDataset(os.path.join(definitions.ROOT_DIR, "translation/nlp_data/gec_dataset.jsonl"))
val_iter = GecDataset(os.path.join(definitions.ROOT_DIR, "translation/nlp_data/gec_dataset.jsonl"), val=True)
