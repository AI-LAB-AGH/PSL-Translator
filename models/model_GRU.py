...
class GRUModel(nn.Module):
    def __init__(self, hidden_size, num_layers, num_classes):
        ...
        self.l = nn.GRU(21 * 2, hidden_size, num_layers)
        self.r = nn.GRU(21 * 2, hidden_size, num_layers)
        self.f2l = nn.GRU(21 * 2, hidden_size, num_layers)
        self.f2r = nn.GRU(21 * 2, hidden_size, num_layers)
        self.h2h = nn.GRU(21 * 2, hidden_size, num_layers)
